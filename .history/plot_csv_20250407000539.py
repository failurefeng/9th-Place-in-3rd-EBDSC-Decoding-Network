...
# 读取数据
df = pd.read_csv("./results/Transformer_puredemod/best/ours/checkpoints/prepare_ppt/zero+std0.5_0.0+model_width/training_progress.csv")
...
ax.set_title("finetune", fontsize=15, pad=15)
