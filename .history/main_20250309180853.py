...
def main(cfgs):
    ...
    if cfgs.modes.train:
        ...
        trainer = Trainer(model=model, model_width=model_width, device=device, optimizer=optimizer, warmup_scheduler=None, main_scheduler=scheduler2, warmup_epochs=warmup_epochs, criterion=criterion,
