...
_C.modes = CN()
_C.modes.demod_method = 'DAELSTM'
_C.modes.demod_network_path = 'amr.models.networks'
_C.modes.width_method = 'DAELSTM'
_C.modes.width_network_path = 'amr.models.networks'
_C.modes.path = ''
