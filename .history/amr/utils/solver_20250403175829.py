...
class Trainer:
    def __init__(self, model, model_width, device, optimizer, base_lr, warmup_scheduler, main_scheduler, warmup_epochs, criterion, save_path, valid_freq=1, early_stop=True, stop_patience= 150,  mask_flag=False, batch_size=512, loss_name = None):
        self.model = model
    ...
    def lr_reset(self):
        for param_group in self.optimizer.param_groups:
            param_group['lr'] = self.base_lr * (0.9 ** (self.cur_epoch//20))  # 每次递减20%
