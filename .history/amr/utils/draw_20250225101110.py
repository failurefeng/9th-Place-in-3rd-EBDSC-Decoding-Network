...
def draw_train(train_loss, train_CQ_score, train_rounded_CQ_score, valid_loss, valid_CQ_score, valid_rounded_CQ_score, save_path):
    ...
    plt.plot(valid_loss, "b.-", label="Val loss")
    plt.xlabel("epoch")
    plt.ylabel("loss")
    plt.legend()

    plt.subplot(1, 3, 2)
    plt.plot(train_CQ_score, "r.-", label="Train CQ_score")
    plt.plot(valid_CQ_score, "b.-", label="Val CQ_score")
    plt.xlabel("epoch")
    plt.ylabel("CQ_score")
    plt.legend()

    plt.subplot(1, 3, 3)
    plt.plot(train_rounded_CQ_score, "r.-", label="Train rounded_CQ_score")
    plt.plot(valid_rounded_CQ_score, "b.-", label="Val rounded_CQ_score")
    plt.xlabel("epoch")
    plt.ylabel("rounded_CQ_score")
    plt.legend()
